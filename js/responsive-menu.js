...
(function(factory) {
  ...
  var okayNav = 'okayNav',
    defaults = {
      ...
      toggle_icon_class: 'main-nav-toggler',
      toggle_icon_content: '<div class="main-nav-toggler__text">Еще<span class="arrow-down ms-2"></div></span><div class="burger"><span class="burger-line"></span><span class="burger-line"></span><span class="burger-line"></span></div>',
  ...
  $.extend(Plugin.prototype, {
    ...
    initEvents: function() {
      ...
      self.document.on('click.okayNav', function(e) {
        ...
        if (e.target.classList.contains('main-nav-toggler') || e.target.classList.contains('main-nav-toggler__text') || e.target.classList.contains('burger') || e.target.classList.contains('burger-line') || e.target.classList.contains('arrow-down')) {
          e.preventDefault();
      ...
      self.window.on('load.okayNav resize', optimizeResize);
    },
    ...
    _collapseAllItems: function() {
      var self = this;
      $('li', self.nav_visible).detach().prependTo(self.nav_invisible);
      self.options.itemHidden.call();
    },
